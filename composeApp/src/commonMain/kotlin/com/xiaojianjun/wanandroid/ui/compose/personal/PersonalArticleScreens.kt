...
fun SharedArticlesScreen(
    ...
    viewModel: SharedArticlesComposeViewModel = viewModel { SharedArticlesComposeViewModel() },
) {
...
fun CollectionScreen(
    navigator: WanNavigator,
    modifier: Modifier = Modifier,
    viewModel: CollectionComposeViewModel = viewModel { CollectionComposeViewModel() },
) {
    PersonalArticleRoute(
...
fun HistoryScreen(
    navigator: WanNavigator,
    modifier: Modifier = Modifier,
    viewModel: HistoryComposeViewModel = viewModel { HistoryComposeViewModel() },
) {
