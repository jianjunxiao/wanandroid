...
fun SharedArticlesScreen(
    ...
    viewModel: SharedArticlesComposeViewModel = viewModel(),
) {
    PersonalArticleRoute(
        ...
        deleteMessage = stringResource(R.string.confirm_delete_shared),
    )
}
...
fun CollectionScreen(
    navigator: WanNavigator,
    modifier: Modifier = Modifier,
    viewModel: CollectionComposeViewModel = viewModel(),
) {
    PersonalArticleRoute(
...
fun HistoryScreen(
    navigator: WanNavigator,
    modifier: Modifier = Modifier,
    viewModel: HistoryComposeViewModel = viewModel(),
) {
    ...
    PersonalArticleRoute(
        ...
        deleteMessage = stringResource(R.string.confirm_delete_history),
    )
}
...
private fun PersonalArticleRoute(
    ...
    DisposableEffect(lifecycleOwner, viewModel, observeCollectionUpdates) {
                        ...
                        items(
                            ...
                            Box(
                                modifier = Modifier.combinedClickable(
                                    ...
                                    onLongClick = { onArticleLongClick?.invoke(article) },
                                ),
                            ) {
                                ArticleCard(
                                    article = article,
