...
private val TopLevelRoutes = listOf(
    TopLevelItem(WanRoute.Home, R.string.home, R.drawable.ic_home_black_24dp),
    TopLevelItem(WanRoute.System, R.string.system, R.drawable.ic_equalizer_black_24dp),
    TopLevelItem(WanRoute.Discovery, R.string.discovery, R.drawable.ic_layers_black_24dp),
    TopLevelItem(WanRoute.Navigation, R.string.navigation, R.drawable.ic_navigation_black_24dp),
    TopLevelItem(WanRoute.Profile, R.string.mine, R.drawable.ic_person_black_24dp),
)
