...
import com.xiaojianjun.wanandroid.ui.compose.common.CollectRepository
...
abstract class BasePersonalArticleViewModel : ComposeBaseViewModel() {
    ...
    open fun onCollectClick(article: Article) {
        launchFlow(block = {
            ...
            Bus.post(USER_COLLECT_UPDATED, article.id to targetCollect)
        })
    }
...
class SharedArticlesComposeViewModel : BasePersonalArticleViewModel() {
...
class CollectionComposeViewModel : BasePersonalArticleViewModel() {
    ...
    override fun onCollectClick(article: Article) {
        ...
        launchFlow(
            block = {
                ...
                Bus.post(USER_COLLECT_UPDATED, originId to false)
            },
            showError = false,
        )
    }
...
class HistoryComposeViewModel : BasePersonalArticleViewModel() {
