...
abstract class BaseHomeArticleViewModel : ComposeBaseViewModel() {
...
class LatestComposeViewModel : BaseHomeArticleViewModel() {
...
class PlazaComposeViewModel : BaseHomeArticleViewModel() {
...
class ProjectComposeViewModel : BaseHomeArticleViewModel() {
...
class WechatComposeViewModel : BaseHomeArticleViewModel() {
