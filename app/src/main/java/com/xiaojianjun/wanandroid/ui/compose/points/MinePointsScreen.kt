...
fun MinePointsScreen(
    ...
    viewModel: MinePointsComposeViewModel = viewModel(),
) {
                    ...
                    state.totalPoints?.let { totalPoints ->
                        item {
                            MinePointsHeader(
                                ...
                                levelRank = stringResource(R.string.level_rank, totalPoints.level, totalPoints.rank),
                            )
                        }
                    }
                    items(
...
private fun MinePointsToolbar(
    ...
    Box(
        ...
        IconButton(
            ...
            Icon(
                painter = painterResource(R.drawable.ic_graphic_eq_black_24dp),
                contentDescription = null,
                tint = WanTheme.colors.textPrimary,
    ...
    Column(
        ...
        Row(
            ...
            Column(modifier = Modifier.weight(1f)) {
                ...
                Text(
                    text = record.date.toDateTime("YYYY-MM-dd HH:mm:ss"),
