package kotlinx.android.synthetic.main.fragment_navigation
...
val Activity.tvFloatTitle: TextView get() = findViewById(R.id.tvFloatTitle)
val Fragment.tvFloatTitle: TextView get() = requireView().findViewById(R.id.tvFloatTitle)
